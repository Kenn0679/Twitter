    ...
    options: async (value: string, { req }) => {
      ...
      try {
        ...
        if (!decoded_forgot_password_token) {
          throw new ErrorWithStatus({
            message: USERS_MESSAGES.USED_FORGOT_PASSWORD_TOKEN_OR_NO_LONGER_EXISTS,
            status: HTTP_STATUS.UNAUTHORIZED
          });
        }
...
const imageSchema: ParamSchema = {
  ...
  isLength: {
    ...
    errorMessage: USERS_MESSAGES.IMAGE_URL_CANNOT_EXCEED_400_CHARACTERS
  }
};
...
const verifyForgotPasswordTokenValidator = validate(
  checkSchema(
    {
  ...
  checkSchema(
    {
      ...
      bio: {
        ...
        isLength: {
          options: { max: 200 },
          errorMessage: USERS_MESSAGES.BIO_CANNOT_EXCEED_200_CHARACTERS
        }
      },
      location: {
        optional: true,
        ...
        isLength: {
          options: { max: 200 },
          errorMessage: USERS_MESSAGES.LOCATION_CANNOT_EXCEED_200_CHARACTERS
        }
      },
      website: {
        optional: true,
        ...
        isLength: {
          ...
          errorMessage: USERS_MESSAGES.WEBSITE_CANNOT_EXCEED_200_CHARACTERS
        }
      },
      username: {
        optional: true,
